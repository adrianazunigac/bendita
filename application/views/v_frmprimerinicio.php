...
<body>
			...
			<div class="row">
				...
				<div class="center-block contenido">	
					...
					<?php
						...
						echo form_open('c_login/c_editarclave',$atributos);
					?>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-9">
									<?php
										...
										"&nbsp;<a href='".base_url('index.php/c_login/c_cerrarsession')."' class='btn btn-warning'>Cancelar</a>";
									?>
								</div>
							</div>
					<?php
	...
	<footer>
		<div class="container">
			<p class="text-right" style="margin-top:3px;">Copyright &copy; Bendita Essence 2019 versi&oacute;n 1.0</p>
		</div>
	</footer>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			if(parseFloat(screen.height) > 768)
      		{
        		$(".content-wrapper").css({
          			'height':'650px'
        		});
